e/// Your crew's name. Both of you are going to change this line.
const CREW_NAME: &str = "EDG";

/// Your crew's motto. You will both change this one too, earlier and separately.
const MOTTO: &str = "a great motto";
...
fn main() {
    ...
    println!("  (Mackey and michael has signed on)");
